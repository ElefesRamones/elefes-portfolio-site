  ...
  return (
    <section id="about" className="py-32 px-6 relative overflow-hidden bg-black">
      ...
      <div className="absolute inset-0">
        ...
        {/* Noise texture */}
        <div className="absolute inset-0 bg-[url('/noise.png')] opacity-25 mix-blend-overlay"></div>
        
        {/* Scanlines */}
        <div className="absolute inset-0 bg-[repeating-linear-gradient(0deg,transparent,transparent_2px,rgba(255,255,255,0.04)_2px,rgba(255,255,255,0.04)_4px)]"></div>
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.03)_2px,transparent_2px),linear-gradient(to_right,rgba(255,255,255,0.03)_2px,transparent_2px)] bg-[size:15px_15px]"></div>
        </div>

        {/* Vignette effect */}
        <div className="absolute inset-0 bg-gradient-radial from-transparent via-black/90 to-black"></div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <motion.div variants={itemVariants} className="md:col-span-4 space-y-8">
            <div className="relative group">
              <div className="aspect-square bg-gradient-to-br from-gray-900 via-black to-gray-900 border-2 border-white/30 overflow-hidden transition-all duration-500 group-hover:border-white/50">
                <div className="w-full h-full flex items-center justify-center relative">
                  ...
                  <div className="absolute inset-0 border-4 border-white/10 -skew-x-3 transition-all duration-500 group-hover:border-white/20"></div>
                </div>
              </div>
              <div className="absolute -bottom-4 -right-4 w-full h-full border-2 border-white/20 -skew-x-3 transition-all duration-500 group-hover:border-white/30"></div>
            </div>
          ...
          <motion.div variants={itemVariants} className="md:col-span-8 space-y-12">
            <div className="space-y-6">
              <p className="text-white text-xl tracking-wide leading-relaxed border-l-4 border-white/30 pl-6 bg-gradient-to-r from-white/10 to-transparent backdrop-blur-sm p-4">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
                {skills.map((skill) => (
                  ...
                  >
                    <div className="bg-gradient-to-br from-white/10 to-transparent border border-white/20 px-4 py-3 transition-all duration-300 group-hover:from-white/20">
            ...
            <motion.div variants={itemVariants} className="pt-6">
              <a
                href="#portfolio"
                className="group inline-flex items-center bg-gradient-to-r from-white/10 to-transparent px-8 py-4 border border-white/30 hover:border-white/70 font-punk tracking-wider text-lg relative overflow-hidden transition-all duration-300 hover:from-white/20"
              >
