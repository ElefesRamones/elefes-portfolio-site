            ...
            <motion.div variants={itemVariants} className="space-y-8 relative">
              ...
              >
                ...
                >
                  ...
                  <span className="relative block bg-accent px-8 sm:px-10 py-3 sm:py-4 rounded-full font-bold text-white 
          ...
          >            <Link href="/">
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-accent/10 via-accent/5 
                         to-accent-2/10 backdrop-blur-sm rounded-full group overflow-hidden relative cursor-pointer"
              >
                <svg
