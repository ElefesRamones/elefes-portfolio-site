          ...
          <div className="max-w-3xl mx-auto space-y-12 text-center">
            ...
            <motion.div variants={itemVariants} className="space-y-8 relative">
              ...
              >
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-accent to-accent-2 opacity-0 blur-xl 
                               group-hover:opacity-20 transition-opacity duration-500" />                  <div className="px-6 py-3 bg-gradient-to-br from-accent/[0.07] via-accent/5 to-transparent 
                               backdrop-blur-sm relative overflow-hidden rounded-xl">
                    <div className="absolute inset-0 bg-gradient-to-r from-accent/10 via-transparent to-accent/10 
            ...
            <motion.div variants={itemVariants} className="pt-12 flex flex-col sm:flex-row gap-6 justify-center">
              {/* View Work Button */}              <Link href="/#portfolio" className="relative isolate w-full sm:w-auto inline-block">
                <motion.div
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="relative"
                >
                  <span className="absolute -inset-8 bg-gradient-to-r from-accent/25 via-accent-2/25 to-accent/25 rounded-[30px] blur-xl opacity-0 group-hover:opacity-100 transition-all duration-500" />
                  <span className="relative inline-flex px-8 sm:px-10 py-3 sm:py-4 rounded-xl font-bold text-white bg-gradient-to-r from-accent to-accent-2 hover:shadow-glow-lg transition-all duration-500 ease-soft">
                    View My Work
                  </span>
                </motion.div>
              </Link>
